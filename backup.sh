...
-- Set BLOCKSIZE to 65536 (64KB) to maximize I/O efficiency with large transfer sizes
WITH COMPRESSION, MAXTRANSFERSIZE = 20971520, BLOCKSIZE = 65536, STATS = 10, INIT, FORMAT, BUFFERCOUNT = 100,
